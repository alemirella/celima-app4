...
<form method="POST" action="{{ route('register') }}" class="mt-4">
    ...
    <div class="mb-3">
        <label for="usuario_nombre" class="form-label">Nombre del administrador</label>
        <input type="text" id="usuario_nombre" name="usuario_nombre" placeholder="Nombre del administrador"
               value="{{ old('usuario_nombre') }}"
               class="form-control @error('usuario_nombre') is-invalid @enderror" autocomplete="off" autofocus>
